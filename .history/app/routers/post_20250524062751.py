...
@router.post("/", status_code=status.HTTP_201_CREATED, tags=["Posts"], response_model=schemas.Post)
...
@router.get("/{id}", tags = ["Posts"], response_model = schemas.Post)
...
@router.put("/{id}", tags = ["Posts"], response_model = schemas.Post)
